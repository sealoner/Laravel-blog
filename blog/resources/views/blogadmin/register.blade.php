	...
	<div class="login_box">
		...
		<div class="form">
			...
			<form action="#" method="post">
				...
				<ul>
					<li>
					<input type="text" name="user_name" class="text" placeholder="请输入注册用户名"/>
						<span><i class="fa fa-user"></i></span>
					</li>
					<li>
						<input type="password" name="user_password" class="text" placeholder="请输入密码"/>
						<span><i class="fa fa-lock"></i></span>
					</li>
					<li>
						<input type="password" name="user_repassword" class="text" placeholder="请再次输入密码"/>
						<span><i class="fa fa-lock"></i></span>
					</li>
					<li>
					...
					<li>
						<a href="{{url('blogadmin/login')}}">已有账号，回到首页</a>
					</li>
				</ul>
			</form>

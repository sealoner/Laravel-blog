...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('blogadmin/article/'.$data->art_id)}}" method="post">
            {{csrf_field()}}
            ...
            <table class="add_tab">
                        ...
                        <select name="cate_id">
                            ...
                            @foreach($cate_list as $vo)
                                <option value="{{$vo->cate_id}}"
                                        @if($data->cate_id==$vo->cate_id) selected @endif
                                >{{$vo->_cate_name}}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    <th>关键词：</th>
                    <td>
                        <input name="art_tag" value="{{$data->art_tag}}">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="art_thumb" size="50px" value="{{$data->art_thumb}}">
                            ...
                            $(function() {
                                $('#file_upload').uploadify({
                                    ...
                                    'onUploadSuccess' : function(file, data, response) {
                                        $('input[name=art_thumb]').val({{$data->art_thumb}});
                ...
                <tr>
                    <th>缩略图预览：</th>
                    <td>
                        <img src="/{{$data->art_thumb}}" alt="" id="art_thumb_img">
                    </td>
                </tr>
                </td>
                </tr>

...
@section('content')
    ...
    <div class="crumb_warp">
        <i class="fa fa-home"></i> <a href="{{url('blogadmin/links')}}">友情链接首页</a> &raquo; 文章管理
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <form action="{{url('blogadmin/links')}}" method="post">
            {{csrf_field()}}
            <table class="add_tab">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <th>友链地址：</th>
                        <td>
                            <input class="lg" name="link_url" value="http://" placeholder="格式为：http://www.XXX.com或http://XXX.com"></input>
                        </td>
                    </tr>
                    <tr>
                        <th>友链排序：</th>
